...
module.exports = {
  name: 'custom-color',
  template: '<span class="component-color" style="display:inline-block;align-self:end;">\
<label class="tap-highlight" style="padding:0.6rem 0.2rem 0.6rem 0.2rem;margin:0">\
    <input\
